...
public interface IFuncionesApi
    {
        ...
        Task<List<ReporteMatriculaColegioDTO>> getCursosColegio(int idAlum, int anio, string codPeriodo);
        Task<List<AlumnoAsistenciaDTO>> getAsistenciasAlumno(int idAlum, string codCurso);
        ...
        Task<List<NotasxBimestreDTO>> getNotasxBimestre(int idAlum, int anio, string codCurso, string codSubperiodo);
        ...
        Task<List<GradoDTO>> GetGrados(string tipoInstitucion);
        ...
        Task<List<ReporteMatriculaColegioDTO>> getCursosAlumno(int idAlumno);
    }
}